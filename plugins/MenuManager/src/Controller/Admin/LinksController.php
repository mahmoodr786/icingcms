 ...
 * Links Controller
 *
 * @property \MenuManager\Model\Table\LinksTable $Links
 */
class LinksController extends AppController
{
    ...
    public function view($id = null)
    {
        $link = $this->Links->get($id, [
            'contain' => ['Menus', 'ParentLinks', 'ChildLinks']
        ]);
    ...
    public function add()
    {
        ...
        $parentLinks = $this->Links->ParentLinks->find('list', ['limit' => 200]);
        $this->set(compact('link', 'menus', 'parentLinks'));
        $this->set('_serialize', ['link']);
    }
