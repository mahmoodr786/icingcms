...
class LinksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'attributes' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'allow_html' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'order' => 1,
            'created' => '2016-08-30 17:17:37',
            'modified' => '2016-08-30 17:17:37'
        ],
    ];
}
