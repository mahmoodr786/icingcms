...
$globalAdminMenu['menus']['MenuManager'] = [
    ...
    'childrens' => [
        [
            ...
            'rawCode' => '',
            'name' => 'Menus',
            'url' => Router::url(['prefix' => 'admin', 'plugin' => 'MenuManager', 'controller' => 'Menus', 'action' => 'index', '_base' => false]),
            'options' => [],
        ],
        [
            'raw' => false,
            'rawCode' => '',
            'name' => 'Links',
            'url' => Router::url(['prefix' => 'admin', 'plugin' => 'MenuManager', 'controller' => 'Links', 'action' => 'index', '_base' => false]),
            'options' => [],
        ],
    ],
];
