...
$globalAdminMenu['menus']['ContentManager'] = [
    ...
    'url' => Router::url(['prefix' => 'admin', 'plugin' => 'ContentManager', 'controller' => 'Pages', 'action' => 'index', '_base' => false]),
    'options' => [
    ...
    'childrens' => [
        ...
        [
            ...
            'rawCode' => '',
            'name' => 'Page Types',
            'url' => Router::url(['prefix' => 'admin', 'plugin' => 'ContentManager', 'controller' => 'PageTypes', 'action' => 'index', '_base' => false]),
            'options' => [],
        ],
    ],
];
